...
async def test_api_resource_meta(client, rmock):
    ...
    assert await res.json() == {
        ...
        "links": [
            {
                "href": f"{config.SERVER_NAME}/api/resources/{RESOURCE_ID}/profile/",
                "type": "GET",
                "rel": "profile",
            },
            {
                "href": f"{config.SERVER_NAME}/api/resources/{RESOURCE_ID}/data/",
                "type": "GET",
                "rel": "data",
            },
        ],
...
async def test_api_resource_data(client, rmock):
    ...
    body = {
        ...
        "links": {
            "next": None,
            "prev": None,
            "profile": f"{config.SERVER_NAME}/api/resources/60963939-6ada-46bc-9a29-b288b16d969b/profile/",
        },
